...
- **Author Profiles**  
  Dedicated profile pages with bios, stats, and wallet info so readers can follow favorite voices.
...
- **Payment Normalization Job**  
  Background job to periodically reconcile legacy payment records and keep lifetime stats accurate.

---

## 4. Platform Expansion

- **Code & API Access for Agentic Workflow**  
...
- **Network Support** 
  Extend the list of supported networks as more become natively available with Coinbase CDP facilitator.

- **x402 v2**
  Migration to x402 v2 once a stable version is available. Currently undre community development. 

---

We’re shipping aggressively while keeping the product stable for writers and readers. 
Have an idea? Reach out on X or Email us. This roadmap evolves with community feedback!
